...
export async function Sidebar() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-3 space-y-3">
